...
@router.message(F.text.in_(["🔢 Кредиты", "🔢 Калькулятор кредитов", "🔢 Кредитный калькулятор", "Кредиты", "Калькулятор кредитов", "Кредитный калькулятор"]))
async def cmd_credit_calculator(message: types.Message):
    ...
    for cmd in ["/credit", "/loan", "/mortgage", "/calc_loan", "🔢 Кредиты", "🔢 Калькулятор кредитов", "🔢 Кредитный калькулятор", "Кредиты", "Калькулятор кредитов", "Кредитный калькулятор"]:
